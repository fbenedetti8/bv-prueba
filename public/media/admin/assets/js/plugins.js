		...
		if ($.fn.daterangepicker) {
			$('.range').daterangepicker({
				...
				locale: {
					...
					monthNames: ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembri', 'Octubre', 'Noviembre', 'Diciembre'],
					firstDay: 1
				}
			},

			function (start, end) {
				var range_updated = start.format('D/MM/YYYY') + ' al ' + end.format('D/MM/YYYY');
			...
			$('.range span').html(startDate.format('D/MM/YYYY') + ' al ' + endDate.format('D/MM/YYYY'));
		}
	}
