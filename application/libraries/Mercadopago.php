...
class Mercadopago {
    function init() {
        $CI =& get_instance();
        $mp = new MP($CI->config->item('mp_client_id'), $CI->config->item('mp_client_secret'));
...
class MP {
    ...
    */
    ...
    public function get_payment_methods($id='') {
        ...
        if($id != '')
            $res = MPRestClient::get("/sites/MLA/payment_methods/{$id}?access_token=" . $access_token);
        else
            $res = MPRestClient::get("/sites/MLA/payment_methods?access_token=" . $access_token);
        return $res;
    }
     ...
     * @return array(json)
     */
    public function create_test_user($preference) {
        $access_token = $this->get_access_token();
        $preference_result = MPRestClient::post("/users/test_user?access_token=" . $access_token, $preference);
        return $preference_result;
    }
}
/**
