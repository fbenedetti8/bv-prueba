...
<?=$header;?>
	...
	<div id="main">
		...
		<div class="banner" style="background-image: url('<?=base_url();?>uploads/destinos/<?=$paquete->destino_id;?>/<?=$paquete->imagen;?>')">
			<div class="container">
