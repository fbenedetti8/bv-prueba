				...
				<tr style="text-align: center">
					<td style="padding: 20px">
						...
						<p style="font-family: 'arial'; color: #282b5a; font-size: 20px; margin: 15px 0 0">
							La reserva <?=$reserva->code;?> del viaje <?=$reserva->nombre;?> ha sido anulada.
							<br>
							En caso de corresponder algún tipo de devolución de dinero recibirás la nota de crédito.<br>
						</p>
