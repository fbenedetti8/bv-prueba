			...
			<table style="font-family: 'arial'; background: white; border: none; border-collapse: collapse" border="0">
				<tr style="text-align: center">
					<td style="padding: 20px">
						...
						<p style="font-family: 'arial'; font-size: 40px; color: #282b5a; margin: 0"><strong style="font-family: 'arial'; font-size: 40px; color: #282b5a">Reserva pagada</strong></p>

						<p style="font-family: 'arial'; color: #282b5a; font-size: 20px; margin: 15px 0 0">
							<strong>Te informamos que ya registramos la totalidad del pago de tu reserva.</strong> Muy pronto recibirás los vouchers que deberás presentar al momento de viajar.
						</p>
