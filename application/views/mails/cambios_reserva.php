			...
			<table style="font-family: 'arial'; background: white; border: none; border-collapse: collapse" border="0">
				<tr style="text-align: center">
					<td style="padding: 20px">
						...
						<p style="font-family: 'arial'; font-size: 40px; color: #282b5a; margin: 0"><strong style="font-family: 'arial'; font-size: 40px; color: #282b5a">Hay cambios en tu reserva</strong></p>

						<p style="font-family: 'arial'; color: #282b5a; font-size: 20px; margin: 15px 0 0">
							<strong>Te informamos que hubo cambios en tu reserva.</strong><br>A continuación podés ver el resumen de tu viaje con los datos actualizados.
						</p>
