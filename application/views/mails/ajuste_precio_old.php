				...
				<tr>
					<td style="padding: 0; text-align: center; font-size: 0;">
						...
						<div style="padding: 0 20px; background-color: white">
							...
							<div>
								<h1 style="color: #001862; font-family: 'arial'; font-size: 28px; margin-bottom: 5px">Ajuste de precio en tu reserva</h1>

								<p style="font-size: 14px; line-height: 22px; width: 100%; margin: 10px auto; display: block; color: #001862"><strong>Te informamos que hubo un ajuste de precio en tu reserva.</strong><br>A continuación podés ver el resumen de tu viaje con el nuevo saldo pendiente de pago.</p>
