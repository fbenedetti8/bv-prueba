				...
				<tr>
					<td style="padding: 0; text-align: center; font-size: 0;">
						...
						<div style="padding: 0 20px; background-color: white">
							...
							<div>
								<h1 style="color: #001862; font-family: 'arial'; font-size: 28px; margin-bottom: 5px">Hay cambios en tu reserva</h1>

								<p style="font-size: 14px; line-height: 22px; width: 100%; margin: 10px auto; display: block; color: #001862"><strong>Te informamos que hubo cambios en tu reserva.</strong><br>A continuación podés ver el resumen de tu viaje con los datos actualizados.</p>

								<a href="<?=site_url('reservas/resumen/'.encriptar($reserva->code));?>" style="box-sizing: border-box; color: #00529b; background-color: #f7f7f7; font-size: 16px; font-weight: 900; text-align: center; padding: 10px 20px; border: 1px solid #6f6f6f; text-decoration: none; display: block; width: 100%; max-width: 255px; margin: 18px auto; text-transform: uppercase">Ver datos del viaje</a>
							</div>
