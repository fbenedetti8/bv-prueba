				...
				<tr>
					<td style="padding: 0; text-align: center; font-size: 0;">
						...
						<div style="padding: 0 20px; background-color: white">
							...
							<div>
								<h1 style="color: #001862; font-family: 'arial'; font-size: 28px; margin-bottom: 5px">Reserva confirmada</h1>

								<p style="font-size: 14px; line-height: 22px; width: 100%; max-width: 320px; margin: 10px auto; display: block; color: #001862">Ya completaste todos datos, tenés hasta el <?=date('d/m',strtotime(fecha_saldar_viaje($reserva->id)));?> para terminar de pagar el viaje</p>
