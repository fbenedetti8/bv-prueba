				...
				<tr>
					<td style="padding: 0; text-align: center; font-size: 0;">
						...
						<div style="padding: 0 20px; background-color: white">
							...
							<div>
								<h1 style="color: #001862; font-family: 'arial'; font-size: 28px; margin-bottom: 5px">Reserva pagada</h1>

								<p style="font-size: 14px; line-height: 22px; width: 100%; margin: 10px auto; display: block; color: #001862"><strong>Te informamos que ya registramos la totalidad del pago de tu reserva.</strong> Muy pronto recibirás los vouchers que deberás presentar al momento de viajar.</p>
