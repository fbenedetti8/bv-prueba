            ...
            <div style="padding: 0 20px; background-color: white">
              ...
              <div>
                ...
                <p style="font-size: 14px; line-height: 22px; width: 100%; max-width: 500px; margin: 10px auto; display: block; color: #001862">
                  <strong>Tu reserva tiene un saldo pendiente de pago.</strong> Es necesario que pagues el saldo pendiente antes del <strong><?=date('d/m/Y', strtotime($reserva->fecha_limite_pago_completo));?></strong>, de lo contrario <strong>tu reserva será anulada</strong>.
                </p>
