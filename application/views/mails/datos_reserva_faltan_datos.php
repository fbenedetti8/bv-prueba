				...
				<tr style="text-align: center">
					<td style="padding: 20px">
						...
						<p style="font-family: 'arial'; color: #282b5a; font-size: 20px; margin: 15px 0 0">
							Tu reserva ha sido generada.<br />
								<strong>Tenés tiempo hasta el <?=date('d/m/Y',strtotime(fecha_completar_datos($reserva->id)));?> a las <?=date('H:i',strtotime(fecha_completar_datos($reserva->id)));?>hs para completar los datos que faltan.</strong>
						</p>
