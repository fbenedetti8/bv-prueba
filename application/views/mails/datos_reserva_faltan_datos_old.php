					...
					<td style="padding: 0; text-align: center; font-size: 0;">
						...
						<div style="padding: 0 20px; background-color: white">
							...
							<div>
								...
								<p style="font-size: 14px; line-height: 22px; width: 100%; margin: 10px auto; display: block; color: #999999">Tu reserva ha sido generada.<br />
								<strong>Tenés tiempo hasta el <?=date('d/m/Y',strtotime(fecha_completar_datos($reserva->id)));?> a las <?=date('H:i',strtotime(fecha_completar_datos($reserva->id)));?>hs para completar los datos que faltan.</strong></p>
