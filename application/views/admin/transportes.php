              ...
              <div class="widget-content" style="display: block;">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
                  <thead>
                    <tr>
                      ...
                      <?php echo $this->admin->th('tipo', 'Tipo', true);?>
                      <?php //echo $this->admin->th('cupo_transporte', 'Cupo', true);?>
                  ...
                  <tbody>
                    ...
                    <tr class="<?php echo alternator('odd', 'even');?>">
                      ...
                      <?php echo $this->admin->td($row->tipo);?>
                      <?php //echo $this->admin->td($row->cupo_transporte);?>
                      <td>
                ...
                <div class="row">
                  <div class="table-footer">
                    <div class="col-md-6">
					  <a class="btn btn-primary add-transporte" href="#" data-href="<?php echo $route;?>/quickadd">Agregar Nuevo</a>
                    </div>
                    <div class="col-md-6">
                      <?php echo $pages; ?>
                    </div>
...
$(document).ready(function(){
		...
		$("body").on('click','a.add-transporte',function(e) {
			e.preventDefault();
					...
					var dialog = bootbox.dialog({
						...
						buttons: {
							...
							ok: {
								...
								callback: function(){
									var furl = $('#fTransporteAdd').attr('action');
									$.post(furl,$('#fTransporteAdd').serialize(),function(d){
										if(d.redirect){
