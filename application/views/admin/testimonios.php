...
tr.ui-sortable-helper { display:table; border:dashed 1px #CCC; }
        ...
        <div class="page-header">
          <div class="page-title">
            ...
            <span>Los testimonios se muestran en la home del sitio.</span>
          </div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
                  <thead>
                    <tr>
                      ...
                      <?php echo $this->admin->th('lugar', 'Lugar', true);?>
                      <?php echo $this->admin->th('testimonio', 'Testimonio', true);?>
                  ...
                  <tbody id="sortable">
                    ...
                    <tr class="<?php echo alternator('odd', 'even');?>">
                      ...
                      <?php echo $this->admin->td($row->lugar.' - '.$row->provincia.' - '.$row->pais);?>
                      <?php echo $this->admin->td(substr($row->testimonio,0,100));?>
