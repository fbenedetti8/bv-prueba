<?php echo $header;	?>
				...
				<div class="page-header">
					<div class="page-title">
						...
						<span>El contenido destacado es el que se muestra en la Home del sitio.<br>Se permiten generar varios contenidos en este módulo pero sólo 1 estará visible a la vez (aquel marcado como Visible).</span>
					</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
									<thead>
										<tr>
											...
											<?php echo $this->admin->th('tipo', 'Tipo contenido', true);?>
