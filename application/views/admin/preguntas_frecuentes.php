<?php echo $header;	?>
				...
				<div class="page-header">
					<div class="page-title">
						...
						<span>Listado de las preguntas frecuentes de dicha sección.</span>
					</div>

					<div class="alert alert-info" style="float:left; max-width: 60%;clear: both; margin-top:10px;">
						<b>Ordenamiento</b>: El ordenamiento de las preguntas es propio de cada categoría, por lo que es recomendable utilizar el filtro de categorías y luego definir el orden de cada pregunta.<br>
						Las Categorías de preguntas en este listado ya se muestran ordenadas, según el criterio definido en el módulo de Categorías de preguntas.
					</div>
					
					<form id="frmSearch" method="post" action="<?php echo $route;?>" class="form-horizontal page-stats" style="width:350px">
						...
						<div class="form-group"> 
							...
							<div class="input-group col-md-9"> 
								<select name="categoria_id" class="form-control" onchange="javascript: location.href = '<?=$route;?>?categoria_id='+this.value;">
									<option value="">Todos</option>
									<? foreach($categorias as $d): ?>
									<option value="<?=$d->id;?>" <?=@$categoria_id==$d->id?'selected':'';?>><?=$d->nombre;?></option>
									<? endforeach; ?>
								</select>
							</div>
			            </div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
									<thead>
										<tr>
											...
											<?php echo $this->admin->th('pregunta', 'Pregunta', true);?>
									...
									<tbody>
										...
										<tr class="<?php echo alternator('odd', 'even');?>">
											...
											<?php echo $this->admin->td($row->pregunta);?>
