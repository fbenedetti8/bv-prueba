                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
                  <thead>
                    <tr>
                      ...
                      <?php echo $this->admin->th('desde', 'Valor Desde', true);?>
                      <?php echo $this->admin->th('hasta', 'Valor Hasta', true);?>
                  ...
                  <tbody>
                    ...
                    <tr class="<?php echo alternator('odd', 'even');?>">
                      ...
                      <?php echo $this->admin->td('$ '.number_format($row->desde, 2));?>
                      <?php echo $this->admin->td('$ '.number_format($row->hasta, 2));?>
                      <td>
