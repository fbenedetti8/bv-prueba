            ...
            <div class="widget box">
              ...
              <div class="widget-content" style="display: block;">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
                  <thead>
                    <tr>
                      <?php echo $this->admin->th('nombre', 'Equipo', true);?>
                      <?php echo $this->admin->th('lider', 'Lider', true);?>
                      <?php echo $this->admin->th('gerente', 'Gerente', true);?>
                  ...
                  <tbody>
                    ...
                    <tr class="<?php echo alternator('odd', 'even');?>">
                      ...
                      <?php echo $this->admin->td($row->coordinador);?>
                      <?php echo $this->admin->td($row->gerente);?>
                      <td>
