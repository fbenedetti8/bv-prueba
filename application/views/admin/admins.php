								...
								<table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
									<thead>
										<tr>
											...
											<?php echo $this->admin->th('usuario', 'Usuario', true);?>
											<?php echo $this->admin->th('email', 'E-Mail', true);?>
											<?php echo $this->admin->th('fecha_ultimo_acceso', 'Ultimo Acceso', true);?>
									...
									<tbody>
										...
										<tr class="<?php echo alternator('odd', 'even');?>">
											...
											<?php echo $this->admin->td($row->usuario);?>
											<?php echo $this->admin->td($row->email);?>
											<td><?=date('d/m/Y H:i:s', strtotime($row->fecha_ultimo_acceso));?></td>
											<td><?=$row->ip;?></td>
											<td>
