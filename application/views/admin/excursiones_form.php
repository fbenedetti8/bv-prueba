    ...
    <div class="col-md-12"> 
              <div class="widget box">
                ...
                <div class="widget-content">
                  <div class="row">
                    <div class="col-md-12"> 
                      <?php echo $this->admin->input('nombre', 'Nombre de excursión', '', $row, false); ?>
					  
					  <?php echo $this->admin->combo('destino_id[]', 'Destino', 's2 comboDestinos', $row, $destinos, 'id', 'nombre',false,true); ?>
                    </div>
                  </div>
                </div>
