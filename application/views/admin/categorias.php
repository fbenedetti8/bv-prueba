                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
                  <thead>
                    <tr>
                      ...
                      <?php echo $this->admin->th('destacada_home', 'Destacada Home', true, array('text-align' => 'center'));?>
                  ...
                  <tbody id="sortable">
                    ...
                    <tr class="<?php echo alternator('odd', 'even');?>">
                      ...
                      <?php echo $this->admin->tdtoggle($row->destacada_home, $route.'/destacada_home', $row->id);?>
