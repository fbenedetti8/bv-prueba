                  ...
                  <div class="row">
                    <div class="col-md-12"> 
                      ...
                      <div class="alert alert-info">
                        <b>Tamaño de imagen</b>: La dimensión recomendada para la imagen es de 125x125px.
                      </div>

                      <?php echo $this->admin->file('imagen', 'Archivo de imagen', '', @$row->imagen, '/uploads/'.$this->page.'/'.@$row->id.'/', $type = 'view',$attributes=""); ?>
                    </div>
                  </div>
                </div>
