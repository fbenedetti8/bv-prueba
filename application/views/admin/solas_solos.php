<?php echo $header;	?>
				...
				<div class="page-header">
					<div class="page-title">
						...
						<span>Este listado muestra las imágenes de la página Viajes de Solas y Solos del sitio.</span>
					</div>
				...
				<!-- <div class="alert alert-info">
					<b>Imágenes de la sección</b>: el slide de dicha sección de la home está contemplado mostrar hasta 6 imágenes.
				</div> -->
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
									...
									<tbody>
										...
										<tr class="<?php echo alternator('odd', 'even');?>">
											<?php echo $this->admin->td_img('/uploads/solas_solos/'.$row->id.'/'.$row->imagen,200);?>
