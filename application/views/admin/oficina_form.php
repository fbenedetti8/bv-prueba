...
<div id="cargarPopup" class="hidden">
  <div class="text-center">
    ...
    <br/>
    <form id="fUpload" method="post" action="<?=site_url('admin/oficina/upload');?>" enctype="multipart/form-data" target="uploader">
...
<iframe src="<?=site_url('admin/oficina/iframe');?>" id="uploader" name="uploader" style="position:absolute; left:-10000px;"></iframe>
...
$(document).ready(function(){
  ...
  $('body').on('change', '.modal-dialog input', function(){
    ...
    $('.modal-dialog form').ajaxForm({
      url: '<?=site_url('admin/oficina/upload');?>',
        beforeSend: function() {
            var percentVal = '0%';
            bar.width(percentVal)
            percent.html(percentVal);
