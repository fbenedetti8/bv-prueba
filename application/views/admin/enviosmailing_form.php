                ...
                <div class="widget-content">
                  <div class="row">
                    <div class="col-md-12"> 
                      ...
                      <?php echo $this->admin->combo('mail_id', 'Mailing', 's2 ', $row, $mailings, 'id', 'asunto',false); ?>
                      <!-- 
                      <?php echo $this->admin->combo('paquete_id', 'Paquete', 's2 ', $row, $paquetes, 'id', 'paquete',false); ?> -->

                      <?php echo $this->admin->combo('estado_id[]', 'Estado', 's2 ', $row, $estados, 'id', 'nombre',false, true); ?>
