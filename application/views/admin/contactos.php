<?php echo $header;	?>
				...
				<div class="page-header">
					<div class="page-title">
						...
						<span>Formularios de contacto recibidos desde el sitio. No incluye los referidos al botón de ACCESO AGENCIAS.</span>
					</div>
					...
					<div class="col-md-12">
						<div class="widget box">
							...
							<div class="widget-content" style="display: block;">
								<table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped" id="table-1">
									<thead>
										<tr>
									...
									<tbody>
										...
										<tr class="<?php echo alternator('odd', 'even');?>">
											...
											<td><?=$row->ip;?></td>
											<td>
												<a href="<?php echo $route;?>/edit/<?php echo $row->id;?>" class="icon-edit">&nbsp;Ver</a>
											</td>
										</tr>
										<?php endforeach; ?>
