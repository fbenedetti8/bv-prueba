							...
							<div class="widget-content" style="display: block;">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
									<thead>
										<tr>
											...
											<?php echo $this->admin->th('idioma', 'Idioma UA', true);?>
											<?php echo $this->admin->th('idioma', 'Idioma TA', true);?>
									...
									<tbody>
										...
										<tr class="<?php echo alternator('odd', 'even');?>">
											...
											<?php echo $this->admin->td($row->idioma_ua);?>
											<?php echo $this->admin->td($row->idioma_ta);?>
								...
								<div class="row">
									<div class="table-footer">
										<div class="col-md-6">
											<a class="btn btn-primary" href="<?php echo $route;?>/add">Agregar Nueva Región</a>
										</div>
										<div class="col-md-6">
											<?php echo $pages; ?>
										</div>
