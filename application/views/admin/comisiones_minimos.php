            ...
            <div class="widget box">
              ...
              <div class="widget-content align-center">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <a href="<?=base_url();?>admin/comisiones_minimos/edit/VEN" class="btn btn-icon input-block-level">
                  ...
                  <div class="col-md-4">
                    <a href="<?=base_url();?>admin/comisiones_minimos/edit/LID" class="btn btn-icon input-block-level">
                      <i class="icon-group"></i>
                      <div>Lider</div>
                      <!-- <span class="label label-danger">2</span> -->
                    </a>
                  ...
                  <div class="col-md-4">
                    <a href="<?=base_url();?>admin/comisiones_minimos/edit/GER" class="btn btn-icon input-block-level">
                      <i class="icon-group"></i>
                      <div>Gerente</div>
                      <!-- <span class="label label-danger">2</span> -->
                    </a>
