    ...
    <th colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#92c665">
      <tr>
        <td height="100"><table width="100%" border="0" cellspacing="8" cellpadding="0">
          <tr>
            <td>
            <font color="#FFFFFF" face="Trebuchet MS" style="font-size:28px; text-transform:uppercase; line-height:32px; display:block; margin-left:15px; margin-top:15px; text-align:left;"> <b>saldo pendiente de pago</b><br>
            </font>
  ...
  <tr>
    <th colspan="4"><table width="100%" border="0" cellspacing="8" cellpadding="0" style="text-align: left;">
      <tr>
        ...
        <b>Pasajero <?=utf8_decode($reserva->nombre).' '.utf8_decode($reserva->apellido);?>:</b><br><br>
        </font>
		<font color="#262626" face="Trebuchet MS" style="font-size:12px; line-height:18px; text-align:left; font-weight: normal;">
			Tu saldo de <b>$<?=$reserva->monto_paquete - $reserva->saldo_por_pagar;?></b> del viaje <b><?=$reserva->titulo." - ".$reserva->subtitulo;?></b> está por vencer.<br>
			En caso de no efectivizarse el pago del saldo del pasaje (<b>$<?=$reserva->saldo_por_pagar;?></b>) tu reserva se anulará automáticamente.<br>
			Esto implica que perderás tu lugar en el mismo, dando la posibilidad de asignárselo a otra persona sin derecho a reclamo, aplicándose las políticas de cancelación correspondientes.<br><br>
        </font>
      ...
      <tr>
        <td width="70%" height="47px" style="background:#195d9d;">         
          <font face="Trebuchet MS" ><a style="font:'Trebuchet MS'; color:#fff; text-decoration:none; display:block; text-align:center; text-transform:uppercase; font-weight:bold;" href="<?=isset($lnk_pago)?$lnk_pago:'';?>">Hac&#233; click aqu&#237; para conocer tu saldo y generar tu pago</a> </font>
        </td>
      </tr> 
    </table></th>
  </tr>
