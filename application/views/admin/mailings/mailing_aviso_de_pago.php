    ...
    <th colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#92c665">
      <tr>
        <td height="100"><table width="100%" border="0" cellspacing="8" cellpadding="0">
          <tr>
            <td>
            <font color="#FFFFFF" face="Trebuchet MS" style="font-size:28px; text-transform:uppercase; line-height:32px; display:block; margin-left:15px; margin-top:15px; text-align:left;"> <b>tu reserva tiene saldo pendiente</b><br>
            </font>
  ...
  <tr>
    <th colspan="4"><table width="100%" border="0" cellspacing="8" cellpadding="0" style="text-align: left;">
      <tr>
        ...
        <b>
        La reserva <?=$reserva->codigo;?> del viaje <?=$reserva->titulo.' - '.$reserva->subtitulo;?>, <b style="color:#f00;">a la fecha registra un saldo pendiente</b>. <br>
		<span style="color:#f00;">El viaje deber&aacute; estar pago en su totalidad 30 d&iacute;as antes de la fecha de salida. Pasado ese
		plazo, se podr&aacute; considerar que el pasajero ANULA su reserva.</span>
        </b>
        </font>
