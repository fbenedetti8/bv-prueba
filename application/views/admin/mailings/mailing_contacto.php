...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="100"><table width="100%" border="0" cellspacing="8" cellpadding="0">
          <tr>
            ...
            <font color="#262626" face="Trebuchet MS" style="font-size:14px; text-transform:uppercase; line-height:18px; display:block; margin-left:15px; text-align:left;"><b> NUEVO CONTACTO RECIBIDO</b></font></b><br>
            </font>     
            </td>
          </tr>
        </table></td>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td style="color:#6a6b6b; font-size:12px; font-weight:bold; text-align:left;">
        	Nuevo contacto desde <a href="<?=base_url();?>" style="text-decoration:none; color:#005496;" target="_blank">BUENAS VIBRAS VIAJES</a>
			<br><br>
        </td>
      </tr>      
    </table>    
   ...
   <th colspan="4">
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td width="74" rowspan="4">&nbsp;</td>        
        <td width="162" rowspan="4" style="color:#6a6b6b; font-size:12px; font-weight:bold; text-align:left;">
        	<font face="Trebuchet MS">Teléfono:</font>
        </td>        
        <td width="290" rowspan="4" style="color:#262626; font-size:12px; font-weight:bold; text-align:left;">
          <font face="Trebuchet MS"><?=$telefono;?></font>
        </td>
        <td width="74" rowspan="4">&nbsp;</td>              
      </tr>      
    </table>    
   ...
   <th colspan="4">
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td width="74" rowspan="4">&nbsp;</td>        
        <td width="162" rowspan="4" style="color:#6a6b6b; font-size:12px; font-weight:bold; text-align:left;">
        	<font face="Trebuchet MS">Asunto:</font>
        </td>        
        <td width="290" rowspan="4" style="color:#262626; font-size:12px; font-weight:bold; text-align:left;">
          <font face="Trebuchet MS"><?=$asunto;?></font>
        </td>
  ...
  <? if(isset($viaje) && isset($tipo) && $viaje && $tipo){ ?>
  <tr>
   <th colspan="4">
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td width="74" rowspan="4">&nbsp;</td>        
        <td width="162" rowspan="4" style="color:#6a6b6b; font-size:12px; font-weight:bold; text-align:left;">
        	<font face="Trebuchet MS"><?=($tipo == 'p') ? 'Paquete' : 'Destino';?>:</font>
        </td>        
        <td width="290" rowspan="4" style="color:#262626; font-size:12px; font-weight:bold; text-align:left;">
   ...
   <th colspan="4">
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td width="74" rowspan="4">&nbsp;</td>        
        <td width="162" rowspan="4" style="color:#6a6b6b; font-size:12px; font-weight:bold; text-align:left;">
        	<font face="Trebuchet MS">Sucursal:</font>
        </td>        
        <td width="290" rowspan="4" style="color:#262626; font-size:12px; font-weight:bold; text-align:left;">
          <font face="Trebuchet MS"><?=$sucursal->nombre;?></font>
        </td>
        <td width="74" rowspan="4">&nbsp;</td>              
      </tr>      
    </table>    
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        ...
        <td width="162" rowspan="4" style="color:#6a6b6b; font-size:12px; font-weight:bold; text-align:left;vertical-align: top;">
        	<font face="Trebuchet MS">Consulta:</font>
        </td>        
        <td width="290" rowspan="4" style="color:#262626; font-size:12px; font-weight:bold; text-align:left;">
          <font face="Trebuchet MS"><?=$consulta;?></font>
        </td>
