...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="100"><table width="100%" border="0" cellspacing="8" cellpadding="0">
          <tr>
            ...
            <font color="#262626" face="Trebuchet MS" style="font-size:14px; text-transform:uppercase; line-height:18px; display:block; margin-left:15px; text-align:left;"><b> Ajuste de saldo por modificación de precio <br>reserva <?=$reserva->codigo;?></b></font></b><br>
            </font>     
            </td>
          </tr>
        </table></td>
      ...
      <tr>
        <td style="color:#6a6b6b; font-size:12px; font-weight:bold; text-align:left;">
        	<font face="Trebuchet MS">
				<? if(isset($msg_percepcion) && $msg_percepcion != ''){ ?>
					<?=nl2br($msg_percepcion);?>
				<? } else { ?>
					Te informamos que hemos realizado un ajuste de precio por aumento en la cotización de la moneda extranjera.
					<? if(isset($data_concepto) && $data_concepto->facturacion == 1){ ?>
						<b>EN ESTE MAIL ENCONTRARÁS ADJUNTA LA FACTURA ELECTRÓNICA EN FORMATO PDF.</b>
					<? } ?>
				<br><br>
				<? } ?>
			</font>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        ...
        <td width="162" rowspan="4" style="color:#6a6b6b; font-size:12px; font-weight:bold; text-align:left;">
        	<font face="Trebuchet MS">Importe:</font>
        </td>        
   ...
   <th colspan="4">
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td width="74" rowspan="4">&nbsp;</td>        
        <td width="162" rowspan="4" style="color:#6a6b6b; font-size:12px; font-weight:bold; text-align:left;">
        	<font face="Trebuchet MS">Concepto registrado:</font>
        </td>        
        <td width="290" rowspan="4" style="color:#262626; font-size:12px; font-weight:bold; text-align:left;">
          <font face="Trebuchet MS"><?=$concepto;?></font>
        </td>
        <td width="74" rowspan="4">&nbsp;</td>              
      </tr>      
    </table>    
  ...
  <tr>
   <th colspan="4">
	...
	<tr>
		<th colspan="4">
			<font face="Trebuchet MS" ><a style="font:'Trebuchet MS'; color:#fff; text-decoration:none; text-align:center; text-transform:uppercase; font-weight:bold; display:block; height:50px;     background: #195d9d;line-height: 45px; vertical-align: middle;margin: 10px 0;" href="<?=isset($lnk_pago)?$lnk_pago:'';?>">Hac&#233; click aqu&#237; para conocer tu saldo y generar tu pago</a> </font>				
		</th>
	</tr>
