      ...
      <tr>
        <td height="100"><table width="100%" border="0" cellspacing="8" cellpadding="0">
          <tr>
            ...
            <font color="#262626" face="Trebuchet MS" style="font-size:14px; text-transform:uppercase; line-height:18px; display:block; margin-left:15px; text-align:left;"><b> UN AMIGO TE RECOMIENDA ESTA PAGINA</b></font></b><br>
            </font>     
            </td>
          </tr>
        </table></td>
    ...
    <th colspan="4"><table width="100%" border="0" cellspacing="8" cellpadding="0">
      <tr>
        ...
        <td style="text-align:left;">
			<font color="#262626" face="Trebuchet MS" style="font-size:12px; line-height:18px; ">
				<b>
					<?=$nombre;?> te envió un mensaje desde el sitio <a href="<?=base_url();?>" style="text-decoration:none; color:#005496;" target="_blank">BUENAS VIBRAS VIAJES</a> y te sugiere que veas esta información:
					<br><br>
					<?=$titulo;?>
					<br><br>
				</b>
  ...
  <tr>
    <th colspan="4">
      ...
      <tr>
        ...
        <td style="text-align:left;">        
		<font color="#262626" face="Trebuchet MS" style="font-size:12px; line-height:18px; text-align:left; font-weight: normal;">
			<?=$comentario;?>
        </font>                    
        </td>
        <td width="8%" rowspan="3">&nbsp;</td>            
	  ...
	  <tr>
        <td width="70%" height="47px" style="background:#195d9d;">         
          <font face="Trebuchet MS" >
			<a style="font:'Trebuchet MS'; color:#fff; text-decoration:none; display:block; text-align:center; text-transform:uppercase; font-weight:bold;" href="<?=isset($link_url)?$link_url:'';?>">
				<?=$link_title;?>
			</a>
		  </font>        
        </td>
