  ...
  <tr>
    <th colspan="4"><table width="100%" border="0" cellspacing="8" cellpadding="0" style="text-align: left;">
      <tr>
        ...
        <b>
        <? if(isset($mensaje_plazo_pago) && $mensaje_plazo_pago != ''){ 
			echo utf8_decode($mensaje_plazo_pago);
		} 
		else { ?>
			La reserva <?=$reserva->codigo;?> del viaje <?=$reserva->titulo.' '.$reserva->subtitulo;?>, se ha anulado debido a que no se registraron pagos dentro del plazo previsto.
		<? } ?>
		<br>
        Si ya realizaste el pago y todav&#237;a no se acredit&#243; comun&#237;cate con nosotros. <br><br>

		Ante cualquier duda, consulta o diferencia, pod&#233;s comunicarte por los medios indicados m&#225;s abajo o respondiendo directamente este mail. <br><br>
        </b>
