...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <img src="<?=base_url();?>media/frontend/mailings/images/ic_banderita.png" border="0" style="display:block; float:left; margin-right:10px; text-align:left;">SALIDA <?=isset($paquete->fechaSalida)?strtoupper($paquete->fechaSalida):'';?>
	</font><br>
    <font style="font-size:16px; text-align:left; display:block; font-weight:100;">
		...
		<font style="font-weight:bold; font-size:12px; text-align:left;">* IMPORTANTE!:</font> <font style=" font-size:12px;">Hay que llegar con media hora de anticipaci&#243;n as&#237; podemos salir a horario.</font>
    </font>
    </th>
  </tr>
