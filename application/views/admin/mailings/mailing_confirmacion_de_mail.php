    ...
    <th colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#92c665">
      <tr>
        <td height="100"><table width="100%" border="0" cellspacing="8" cellpadding="0">
          <tr>
            <td>
            <font color="#FFFFFF" face="Trebuchet MS" style="font-size:32px; text-transform:uppercase; line-height:32px; display:block; margin-left:15px; margin-top:15px; text-align:left;"> <b>confirmaci&Oacute;n de email</b><br>
            </font>
            <font color="#262626" face="Trebuchet MS" style="font-size:14px; text-transform:uppercase; line-height:18px; display:block; margin-left:15px; text-align:left;"><b> Continu&Aacute; el proceso de Reserva</b></font></b><br>
            </font>     
            </td>
          </tr>
        </table></td>
  ...
  <tr>
    <th colspan="4"><table width="100%" border="0" cellspacing="8" cellpadding="0">
      <tr>
        ...
        <b>Te enviamos este email para confirmar que seas el titular de la cuenta que 
            ingresaste para reservar el viaje a:</b></font>
            <br>
        <font color="#e14318" face="Trebuchet MS" style="font-size:16px; line-height:20px; text-align:left;">
        <b><?=$paquete->titulo.' '.$paquete->subtitulo;?></b>
        </font>
        </td>
        <td width="7%" rowspan="3">&nbsp;</td>        
      </tr>
      <tr>
        <td width="70%" height="47px" style="background:#195d9d;">         
          <font face="Trebuchet MS" ><a style="font:'Trebuchet MS'; color:#fff; text-decoration:none; display:block; text-align:center; text-transform:uppercase; font-weight:bold;" href="<?=$link;?>">continuar con el proceso de reserva</a> </font>        
        </td>
      </tr>
      <tr>
        <td>
        <font color="#262626" face="Trebuchet MS" style="font-size:12px; line-height:18px; font-weight:bold; text-align:center; display:block;">
        ****** Tu reserva no est&aacute; finalizada hasta que realices los todos los pasos. ******
        </font>
        </td>
      </tr>
    </table></th>
