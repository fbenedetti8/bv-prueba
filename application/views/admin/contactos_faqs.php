<?php echo $header;	?>
				...
				<div class="page-header">
					<div class="page-title">
						...
						<span>Formularios de contacto recibidos a través del formulario de Preguntas Frecuentes presente en el sitio.</span>
					</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
									<thead>
										<tr>
											...
											<?php echo $this->admin->th('comentario', 'Comentario', true);?>
									...
									<tbody>
										...
										<tr class="<?php echo alternator('odd', 'even');?>">
											...
											<?php echo $this->admin->td($row->comentario);?>
