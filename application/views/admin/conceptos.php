								...
								<table cellpadding="0" cellspacing="0" border="0" class="table table-hover  table-striped">
									<thead>
										<tr>
											...
											<?php echo $this->admin->th('aplica_a', 'Aplica a', true);?>
											<?php echo $this->admin->th('pasa_a_confirmada', 'Pasa a Confirmada', true, array('text-align'=>'center'));?>
											<?php echo $this->admin->th('facturacion', 'Facturación', true, array('text-align'=>'center'));?>
											<?php echo $this->admin->th('envia_mail', 'Envía mail', true, array('text-align'=>'center'));?>
									...
									<tbody>
										...
										<tr class="<?php echo alternator('odd', 'even');?>">
											...
											<?php echo $this->admin->td($row->aplica_a);?>
											<td align="center"><i class="glyphicon glyphicon-<?=$row->pasa_a_confirmada?'ok':'remove';?>"></i></td>
											<td align="center"><i class="glyphicon glyphicon-<?=$row->facturacion?'ok':'remove';?>"></i></td>
											<td align="center"><i class="glyphicon glyphicon-<?=$row->envia_mail?'ok':'remove';?>"></i></td>
											<td>
